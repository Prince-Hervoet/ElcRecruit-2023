  ...
  <view class="postInfo-container">
    ...
    <view class="postInfo-table-container">
      <view class="postInfo-table">
        ...
        <view>
          <MyPicker header-name="所属学院 *" :value="studentInfo.college" :arr="collegeArr" @onChange="setCollege">
          </MyPicker>
        </view>
        <view>
...
const collegeArr = ["机电工程学院", "自动化学院", "轻工化工学院", "信息工程学院", "土木与交通工程学院", "管理学院", "计算机学院", "材料与能源学院", "环境科学与工程学院", "外国语学院", "数学与统计学院", "物理与光电工程学院", "艺术与设计学院", "法学院", "建筑与城市规划学院", "经济学院", "马克思主义学院", "国际交流学院", "生物医药学院", "先进制造学院", "生态环境与资源学院", "集成电路学院", "商学院", "国际教育学院", "体育学院", "继续教育学院", "创新创业学院"];
